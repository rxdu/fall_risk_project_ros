  ...
  class RosGstCapture // Create a class called RosGstCapture
  {
    public: 
      RosGstCapture() // Constructor
      {
        ...
        _pub = _nh.advertise<audio_common_msgs::AudioData>("audio_turtlebot", 10, true); // Topic name: /audio_turtlebot
...
{
  ros::init(argc, argv, "audio_capture_turtlebot"); // Node name: audio_capture_turtlebot
