...
CC            := gcc
CXX           := g++
CFLAGS        +=  -DP_64BIT -DPTRACING=1 -D_REENTRANT -D_GNU_SOURCE=1 -fno-exceptions -I/usr/local/include -I/usr/include/SDL   -fPIC   -I/usr/local/include -I$(PLUGINDIR)/../include -I$(PLUGINDIR)
...
OBJDIR := $(PLUGINDIR)/../lib_linux_x86_64/plugins/$(BASENAME)
